...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('deployment_status', sa.String(20), nullable=False, server_default='staging'),
    ...
    op.create_index('ix_model_versions_deployment_status', 'model_versions', ['deployment_status'], unique=False)
    op.create_index('ix_model_versions_is_deleted', 'model_versions', ['is_deleted'], unique=False)

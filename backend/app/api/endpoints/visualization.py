...
class VisualizationReportSchema(BaseModel):
    ...
    visualization_type: str = Field("simulated_explainability", description="Type of visual map generated")
...
@router.get("/report/{inspection_id}", response_model=VisualizationReportSchema, summary="Get visual diagnostic heatmap and reasoning report")

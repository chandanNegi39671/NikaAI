...
YOLO_INFERENCE_TIME = Histogram(
    "nika_yolo_inference_time_seconds",
    "YOLOv8 inference execution time in seconds"
)

YOLO_FPS = Gauge(
    "nika_yolo_fps",
    "Current throughput frame rate (FPS) of YOLO model"
)

# Cache Telemetry
CACHE_HITS = Counter(
    "nika_cache_hits_total",
    "Total count of cache hits",
    ["cache_type"]
)

CACHE_MISSES = Counter(
    "nika_cache_misses_total",
...
DB_CONNECTIONS = Gauge("nika_db_connections_active", "Number of active database pool connections")

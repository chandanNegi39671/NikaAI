...
class LocalStorageProvider(StorageProvider):
    ...
    def __init__(self) -> None:
        self.upload_dir = Path(__file__).resolve().parent.parent.parent.parent / "static" / "uploads"
...
class S3StorageProvider(StorageProvider):
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            logger.warning(f"Failed to initialize S3 boto3 provider: {exc}. Falling back to Local.")

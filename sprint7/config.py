...
class Settings(BaseSettings):
    ...
    # All optional: a channel with no credentials configured is treated as
    # "not enabled" rather than silently pretending to succeed.
    smtp_host: str | None = None
    smtp_port: int = 587
    smtp_username: str | None = None
    smtp_password: str | None = _get_secret("smtp_password", "") or None
    ...
    twilio_auth_token: str | None = _get_secret("twilio_auth_token", "") or None
    twilio_from_number: str | None = None

    notification_max_retries: int = 3
    notification_escalation_minutes: int = 15  # unacknowledged critical alerts escalate after this long
